...
class ProcessSummary : public ProcmonDataset {
    public:
...
struct IdentifiedFilesystems: public ProcmonDataset {
    ...
    virtual inline static const size_t getMagicNumber() const 
...
template <>
void Hdf5Type<IdentifiedFilesystem>::initializeType(Hdf5File *file) {
...
template <>
void Hdf5Type<ProcessSummary>::initializeType(Hdf5File *file) {
